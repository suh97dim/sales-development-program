 ...
 !function(o, e) {
        ...
        var t = r(1)
          , c = function() {
            ...
            o.prototype.addOrSubtract = function(e) {
                ...
                s = r[1]);
                for (var a = new Uint8ClampedArray(s.length), d = s.length - c.length, n = 0; n < d; n++)
                    a[n] = s[n];
            ...
            o.prototype.multiplyPoly = function(e) {
                ...
                for (var r = this.coefficients, c = r.length, s = e.coefficients, a = s.length, d = new Uint8ClampedArray(c + a - 1), n = 0; n < c; n++)
                    for (var l = r[n], i = 0; i < a; i++)
                        d[n + i] = t.addOrSubtractGF(d[n + i], this.field.multiply(l, s[i]));
    ...
    , function(o, e, r) {
        ...
        e.binarize = function(o, e, r, n) {
            ...
            var M = t.BitMatrix.createEmpty(e, r)
              , L = null;
            for (n && (L = t.BitMatrix.createEmpty(e, r)),
            P = 0; P < f; P++)
                for (v = 0; v < m; v++) {
                    for (var N = a(v, 2, m - 3), I = a(P, 2, f - 3), O = (h = 0,
                    -2); O <= 2; O++)
                        for (var z = -2; z <= 2; z++)
                            h += w.get(N + O, I + z);
                    var S = h / 25;
            ...
            var B = new c.default(s,d)
              , k = function(o, e, r, t) {
                ...
                for (var s = e, a = r, d = o.zero, n = o.one; a.degree() >= t / 2; ) {
                    ...
                    if (n = B.multiplyPoly(d).addOrSubtract(i),
                    a.degree() >= s.degree())
                        return null
                }
            ...
            for (var C = function(o, e, r) {
                for (var c = r.length, s = new Array(c), a = 0; a < c; a++) {
                    for (var d = o.inverse(r[a]), n = 1, l = 0; l < c; l++)
                        a !== l && (n = o.multiply(n, t.addOrSubtractGF(1, o.multiply(r[l], d))));
    ...
    , function(o, e, r) {
        ...
        function n(o, e, r, t) {
            ...
            s = Math.floor(o.x),
            d = Math.floor(e.y),
            n = Math.floor(e.x)) : (c = Math.floor(o.x),
            s = Math.floor(o.y),
            d = Math.floor(e.x),
            n = Math.floor(e.y));
        ...
        function l(o, e, r, t) {
            var c, s = e.y - o.y, a = e.x - o.x, d = n(o, e, r, Math.ceil(t / 2)), l = n(o, {
                x: o.x - a,
                y: o.y - s
        ...
        e.locate = function(o) {
            for (var e = [], r = [], n = [], l = [], i = function(t) {
                for (var a = 0, i = !1, B = [0, 0, 0, 0, 0], k = function(e) {
                    var n = o.get(e, t);
                    if (n === i)
                        a++;
                    else {
                        ...
                        if (m) {
                            ...
                            (v = l.filter(function(o) {
                                return y >= o.bottom.startX && y <= o.bottom.endX || h >= o.bottom.startX && y <= o.bottom.endX || y <= o.bottom.startX && h >= o.bottom.endX && B[2] / (o.bottom.endX - o.bottom.startX) < s && B[2] / (o.bottom.endX - o.bottom.startX) > c
                            })).length > 0 ? v[0].bottom = P : l.push({
                                top: P,
                                bottom: P
                            })
                        }
                ...
                n.push.apply(n, l.filter(function(o) {
                    return o.bottom.y !== t
                })),
            ...
            var f = function(o, e, r) {
                var t, c, s, d, n, l, i, B = a(o, e), k = a(e, r), u = a(o, r);
                return k >= B && k >= u ? (n = (t = [e, o, r])[0],
                l = t[1],
                i = t[2]) : u >= k && u >= B ? (n = (c = [o, e, r])[0],
                l = c[1],
                i = c[2]) : (n = (s = [o, r, e])[0],
                l = s[1],
                i = s[2]),
                (i.x - l.x) * (n.y - l.y) - (i.y - l.y) * (n.x - l.x) < 0 && (n = (d = [i, n])[0],
                i = d[1]),
                {
                    bottomLeft: n,
                    topLeft: l,
